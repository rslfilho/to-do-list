...
Tempo de curso: 1 mês e 1 dia

O objetivo deste projeto era desenvolver uma lista de tarefas onde o usuário poderia acrescentar tarefas, removê-las, marcá-las como completadas, entre outras funcionalidades. Neste projeto usei `HTML`, `CSS` e `JavaScript`.
